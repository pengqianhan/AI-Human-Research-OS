...
* [paper_skeleton.md](paper_skeleton.md) - Manuscript control sheet and source map.
* [Code/README.md](Code/README.md) - Reproducible code run and numeric results.
* [log.md](log.md) - Folder-level update log for quick orientation.

# Project Areas

* [Code/](Code/) - Synthetic linear-fit experiment.
