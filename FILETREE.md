...
- `Code/` - Project scripts, notebooks, analyses, and helper code. <!--hash:4e2879d9-->
- `Ideas/` - Research ideas, hypotheses, outlines, meeting notes, and reflections. <!--hash:bcb5bee2-->
- `Paper/` - Writing materials, manuscript drafts, reports, and related outputs. <!--hash:9349f800-->
...
- `Datasets/` - Raw or processed datasets used by project code and analyses. <!--hash:2d687d89-->
