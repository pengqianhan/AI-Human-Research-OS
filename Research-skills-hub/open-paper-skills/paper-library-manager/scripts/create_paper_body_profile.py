...
# ///
"""Create or merge a paper_body profile for paper-library.toml.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate or merge a paper_body profile for paper-library.toml."
    )
    parser.add_argument(
        "--description",
        "-d",
    ...
    parser.add_argument(
        ...
        help=(
            "Path to paper-library.toml. Defaults to this skill's bundled "
