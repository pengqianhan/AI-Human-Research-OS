...
* [claude-science](claude-science/index.md) - Claude Science skills sourced from HughYau/AcademicForge's `site-first/skills/claude-science` collection, with local portability notes.
