...
|---|---|---|---|
| Example_Project (OS smoke test) | `projects-folder/Example_Project/` | complete — kept as worked example | delete if unwanted (decision D6 in [`CHANGE_SUMMARY.md`](../CHANGE_SUMMARY.md)) |

## Key Decisions (cross-project)

| Date | Decision | Why |
|---|---|---|
| 2026-06-12 | Research OS normalized: entry chain (AGENTS/CLAUDE → INSTRUCTION → FILETREE → memory), six core workflows, 3-layer memory, hub-as-store skill lifecycle | task_en.md normalization task; see [`CHANGE_SUMMARY.md`](../CHANGE_SUMMARY.md) |
