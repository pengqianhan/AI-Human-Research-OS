...
* What failure modes are specific to *editing* an existing 3D artifact (both papers' refinement/edit query types) versus building one from scratch, and do the same verifier designs catch both?
